...
function advMats:Set(ent, texture, data, submatid)
	if (SERVER) then
		...
		data.UseNoise = data.UseNoise or 0
		...
		data.UseBump = data.UseBump or 0
		data.BumpTexture = data.BumpTexture or ""
		data.UseLightwarp = data.UseLightwarp or 0
		data.LightwarpTexture = data.LightwarpTexture or ""
		data.UseEnvMap = data.UseEnvMap or 0
		...
		data.UsePhong = data.UsePhong or 0
